...
window.MagicTest = {
  start: function start() {
    ...
    document.addEventListener("mouseover", _Mutation__WEBPACK_IMPORTED_MODULE_3__.mutationEnd, false); // $(document).on("click", "*", ClickFunction);
